...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "Made by Nate Brook junior software engineer using Babel.js , Html , JavaScript , Css , and VSC",
        )));
};
const Time = () => {
    ...
    const getItems = () => {
        return [{
            ...
            return (React.createElement("div", { key: item.id, className: "quick-nav-item clear-button" },
                ...
                React.createElement("a", { href: item.link, className: "quick-nav-item-label" }, item.label)));
        });
    };
...
const Tools = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-toolbox", id: "tools-section", title: "Our Products:" }, getTools()));
};
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
            desc: "This is a free but secure app developed to create random passwords using letter numbers and symbols.",
            id: 1,
            image: "/img/PasswordGenerator.png",
            title: "Password Generator",
            link: "/dist/random-password/index.html",
        }, {
            desc: "This is a free app developed to create emoji pixel images from simple png / jpeg images.",
            id: 2,
            image: "/img/EmojiArt.png",
            title: "Emoji Art Maker",
            link: "/dist/emoji-art/index.html"
        }, {
            desc: "This is a free app developed to create animated videos for music. It makes some particles follow the pattern of the sound.",
            id: 3,
            image: "/img/AudioVisualizer.png",
            title: "Audio visualizer",
            link: "/dist/audio-visualizer/index.html"
        },].map((restaurant) => {
            const styles = {
                backgroundImage: `url(${restaurant.image})`
            };
            const handleOnClick = () => {
                let passwordroot = document.getElementById('password-component');
                passwordroot.classList.toggle("show")
            };
            return (React.createElement("a", {onClick: handleOnClick, key: restaurant.id, id: restaurant.id , className: "restaurant-card background-image", style: styles },
    ...
    return (React.createElement(MenuSection, { icon: "fa fa-browser", id: "restaurants-section", title: "Explore" }, getRestaurants()));
};

const Movies = () => {
    const getMovies = () => {
        return [{
            desc: "A tale of a teenager watching over a large portion of space.",
            id: 1,
            icon: "fa-solid fa-galaxy",
            image: "/img/AboutMe.png",
            title: "About Me"
        }, {
