const musicSquadHeading = document.querySelector("#text h1:nth-of-type(1)");
const musicSquadHeading2 = document.querySelector("#text h1:nth-of-type(2)");
const musicSquadInput = document.querySelector("#music-squad-input");
const musicSquadInput2 = document.querySelector("#music-squad-input2");

musicSquadInput.addEventListener("input", () => {
  musicSquadHeading.textContent = musicSquadInput.value;
});
musicSquadInput2.addEventListener("input", () => {
  musicSquadHeading2.textContent = musicSquadInput2.value;
});
...
const processAudio = mp3 => {
  let audio = null
  if(mp3 === 'default'){
    audio = new Audio('./Waiting For Love.mp3')
